...
pub fn build(b: *std.Build) void {
    ...
    _ = sdk.addR4MFWithOptions(b.path("module.R4MF"), .{
        .zig_module_roots = &.{ libraries.namedLazyPath("r4gfx_zig_binding"), libraries.namedLazyPath("r4gfx_queue"), libraries.namedLazyPath("r4gfx_edid"), libraries.namedLazyPath("r4gfx_outputs"), libraries.namedLazyPath("r4nv_zig_binding"), libraries.namedLazyPath("r4nak_zig_binding"), libraries.namedLazyPath("r4nak_worker"), libraries.namedLazyPath("r4amd_zig_binding") },
    });
